...
2026-09-16用户已授权本项目在已批准范围内，通过必要测试与独立审查后自主squash合并。历史Draft PR #7已合并；后续使用经核验的短分支/PR绑定，不再重复请求合并批准。正式运行包激活、恢复业务及真实交易不在该授权内；业务保持PAUSED。上文旧交付记录中的不自动合并条款按此更新执行。
