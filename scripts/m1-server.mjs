...
export async function serve({codeRoot,dataRoot,port,paused=true}){
 ...
 const server=http.createServer(async(req,res)=>{try{
  ...
  else if(url.pathname==='/api/m1/runtime')body=JSON.stringify(await runtimeDisplay(dataRoot,{paused}));
